...
export type GoalState = "active" | "paused" | "running" | "needs_decision" | "failed" | "completed" | "dormant" | "cancelled";
...
export type GoalEvent = ProgressEvent | DecisionEvent | CompleteEvent | FailureEvent | DiagnosticEvent | NotificationEvent;
